          ...
          <Card className='h-full w-full overflow-hidden p-4 border-none bg-cardBackgroundColor rounded-md text-left'>
            <CardContent className='p-0 h-full flex flex-row items-center justify-around'>
              ...
              <CardDescription className='p-0 pl-2 flex flex-col justify-center items-left text-cardTextColor'>
                <span className='text-[16px] font-extrabold cursor-default'>{cardsData.leaveDetailsCard.value}</span>
                <span className='text-[10px]'>{cardsData.leaveDetailsCard.title}</span>
              </CardDescription>
            </CardContent>
          </Card>
        </div>
        ...
        <div className='w-1/2 h-full rounded-sm rounded-tr-md'>
          <Card className='h-full w-full overflow-hidden p-4 border-none bg-cardBackgroundColor rounded-md text-left'>
            <CardContent className='p-0 h-full flex flex-row items-center justify-around'>
              ...
              <CardDescription className='p-0 pl-2 flex flex-col justify-center items-left text-cardTextColor'>
                <span className='text-[16px] font-extrabold cursor-default'>{cardsData.shiftDetailsCard.value}</span>
                <span className='text-[10px]'>{cardsData.shiftDetailsCard.title}</span>
              </CardDescription>
            </CardContent>
          </Card>
        </div>
            ...
            <CardContent className='p-0 h-full flex flex-row items-center justify-around'>
              ...
              <CardDescription className='p-0 pl-2 flex flex-col justify-center items-left text-cardTextColor'>
                <span className='text-[16px] font-extrabold cursor-default'>
                  {cardsData.monthlyAttendanceCard.value} / {cardsData.monthlyAttendanceCard.totalValue}
                </span>
                <span className='text-[10px] font-semibold'>{cardsData.monthlyAttendanceCard.title}</span>
                <span className='text-[10px]'>{cardsData.monthlyAttendanceCard.description}</span>
              </CardDescription>
            </CardContent>
          </Card>
        </div>
