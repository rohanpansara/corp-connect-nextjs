...
export function DataTable<TData, TValue>({ columns, data, onNoResultsFound }: DataTableProps<TData, TValue>) {
    ...
    <div className='rounded-md border w-full bg-sidebarBackground'>
      ...
      <div className='p-3'>
        <Table>
          ...
          <TableBody className='p-3'>
            {noResults ? (
              <TableRow>
                <TableCell colSpan={columns.length} className='h-12 text-center text-gray-400 italic'>
                  No results.
                </TableCell>
              </TableRow>
            ) : (
      ...
      <div className='flex items-center justify-end space-x-2 p-3'>
        <Button
          ...
          className={!table.getCanPreviousPage() ? 'cursor-not-allowed' : 'hover:cursor-pointer'}
        >
          Previous
        </Button>
        <Button
          ...
          className={!table.getCanNextPage() ? 'cursor-not-allowed' : 'hover:cursor-pointer'}
        >
          Next
        </Button>
      </div>
