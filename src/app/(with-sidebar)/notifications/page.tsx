...
const NotificationPage = () => {
  ...
  const handleClick = async () => {
    const response = await apiClient.post('/update/update-socket', JSON.stringify({ count: count }))
    console.log(response?.data)
  }

  return (
    <div className={`min-h-screen w-full bg-mainBackground flex items-center flex-col gap-6 p-6 ${poppins.className}`}>
      {/* Click Button */}
